...
CREATE TABLE "User" (
    ...
    phone VARCHAR(9), 
    email VARCHAR(100), 
    passwordHash BYTEA, -- He leido que almacenar los strings de hash en binrario es mas eficiente y ocupa menos espacio, en este caso utilizamos BYTEA que funciona como un TEXT bianrio
